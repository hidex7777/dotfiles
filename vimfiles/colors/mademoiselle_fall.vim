...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || (&term =~? "^konsole" && s:old_kde())
    ...
    CSAHi CursorIM term=NONE cterm=NONE ctermbg=231 ctermfg=244 gui=NONE guibg=#fffff5 guifg=#808080
    ...
    CSAHi CursorLine term=underline cterm=NONE ctermbg=253 ctermfg=237 gui=NONE guibg=#dddddd guifg=#3c3c3c
    CSAHi ColorColumn term=reverse cterm=NONE ctermbg=217 ctermfg=fg gui=NONE guibg=#ffa0a0 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=231 ctermfg=244 gui=NONE guibg=#fffff5 guifg=#808080
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi CursorIM term=NONE cterm=NONE ctermbg=255 ctermfg=244 gui=NONE guibg=#fffff5 guifg=#808080
    CSAHi SpellRare term=reverse cterm=undercurl ctermbg=bg ctermfg=201 gui=undercurl guibg=bg guifg=fg guisp=#ff00ff
    CSAHi SpellLocal term=underline cterm=undercurl ctermbg=bg ctermfg=37 gui=undercurl guibg=bg guifg=fg guisp=#008080
    ...
    CSAHi Cursor term=NONE cterm=NONE ctermbg=255 ctermfg=244 gui=NONE guibg=#fffff5 guifg=#808080
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi CursorIM term=NONE cterm=NONE ctermbg=79 ctermfg=83 gui=NONE guibg=#fffff5 guifg=#808080
    ...
    CSAHi CursorLine term=underline cterm=NONE ctermbg=87 ctermfg=80 gui=NONE guibg=#dddddd guifg=#3c3c3c
    CSAHi ColorColumn term=reverse cterm=NONE ctermbg=69 ctermfg=fg gui=NONE guibg=#ffa0a0 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=79 ctermfg=83 gui=NONE guibg=#fffff5 guifg=#808080
